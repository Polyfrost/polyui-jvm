...
class MarkdownHeadingElement(
...
) : HeadingElement<MarkdownStyle, Renderer>(style, layoutStyle, parent, qName, attributes) {
    // If this is a heading without divider it is possible the color is null
    private var polyColor: PolyColor? = headingStyle.dividerColor?.let { PolyColor.from(headingStyle.dividerColor) }
    ...
    override fun drawDivider(
        ...
        renderer.rect(x, y, width, height, polyColor!!)
    }
}
